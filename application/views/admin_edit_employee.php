    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    <h2><span class="fa fa-user"></span> Update Employee</h2>
                    <ol class="breadcrumb">
                        <li>
                            Administrator
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Update Employee Wizard -
                                    <small>Enter the details of the Employee you want to Update</small>
                                </h5>
                            ...
                            <div class="ibox-content">
                                <form name="create_jurnal" method="post" id="add_cad_user" class="form-horizontal"
                                      action="<?= base_url('/index.php/Users/update_employee') ?>" enctype="multipart/form-data">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="EmployeeName" required="" type="text" class="form-control"
                                                           value="<?php echo $EmployeeData->EmployeeName; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="EmployeeNumber" required="" type="text" class="form-control"
                                                          value="<?php echo $EmployeeData->EmployeeNumber; ?>">
                                                </div>
                                            </div> 
                                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class=" panel-body">
                                                    <input value="<?php echo $EmployeeData->EmpId; ?>" type="hidden" name="hdnID" id="hdnID">
                                                </div>
                                            </div>
