    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    <h2><span class="fa fa-user"></span> Create System User</h2>
                    <ol class="breadcrumb">
                        <li>
                            Administrator
                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Create User Wizard -
                                    <small>Enter the details of the user you want to create</small>
                                </h5>
                            ...
                            <div class="ibox-content">
                                <form name="create_jurnal" method="post" id="add_cad_user" class="form-horizontal"
                                      action="<?= base_url('/index.php/Users/add_new_user') ?>" enctype="multipart/form-data">
                                    <div class="row">
                                                    ...
                                                    <select name="empid"  
                                                            class="chosen-select form-control">
                                                                ...
                                                                foreach ($users as $user):
                                                                    ?>
                                                            <option
                                                                value="<?= $user->EmpId ?>"><?= $user->EmployeeName." - ".$user->Designation;?></option>
