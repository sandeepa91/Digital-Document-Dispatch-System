        ...
        <ul class="nav" id="side-menu">
            ...
            <li  >
                ...
                <ul class="nav nav-second-level">
                    <li ><a href="<?php echo base_url() ?>index.php/Users/AddEmployee">Add Employee</a></li>
                    <li ><a href="<?php echo base_url() ?>index.php/Users/ViewEmployee">Edit Employee</a></li>
                </ul>
            </li>
            <li  >
                <a href="index.html"><i class="fa fa-user"></i> <span class="nav-label">User  </span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li ><a href="<?php echo base_url() ?>index.php/Users/AddUser">Add User</a></li>
                    <li ><a href="<?php echo base_url() ?>index.php/Users/ViewUser">Edit User</a></li>
                </ul>
            </li>
            <li  >
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li ><a href="<?php echo base_url() ?>index.php/dashboard">Approval Document</a></li>
