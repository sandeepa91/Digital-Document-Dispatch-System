                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Manage Users
                                <small>Manage User on the system</small>
                            </h5>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <button class="btn btn-sm btn-default btn-outline view"
                                                        data-journal-id="<?= $user->EmpId ?>">View
                                                </button>
                                                <a href="<?php echo base_url() ?>index.php/Users/edit_User/<?= $user->EmpId ?>" target="_blank">
                                                    <button class="btn btn-sm btn-success"
                                                            data-journal-id="<?= $user->EmpId ?>"> Edit
                                                    </button>
                                                </a>
                                            </div>
                                        </td>
