...
<body>
<div id="wrapper">
    <?php $this->load->view('partial/manager_navigation'); ?>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="ibox-content">
                                                        <h3 class="media-heading">
                                                            <?= $review_document->DocId . $review_document->Remarks ?>
                                                        </h3>
                                                        <?php
                                                        /**
                                                         ...
                                                         */
                                                        ?>
                                                        <span>Content : <?= $review_document->Content ?> </span><br/>
